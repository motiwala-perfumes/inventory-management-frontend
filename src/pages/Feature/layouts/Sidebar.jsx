          ...
          <div className="sidebar-inner slimscroll">
            <div id="sidebar-menu" className="sidebar-menu">
              ...
              <ul>
                ...
                <li
                  className={`${"/index" === pathName || "/" === pathName ? "active" : ""
                    }`}
                >
              ...
              >
                ...
                <li
                  className={`${"/user-type-management" === pathName
                    ? "active"
                    : ""
                    }`}
                  // style={{
                  //   display: showHide("user-type") ? "none" : "block",
                  // }}
                >
                  <Link
                    to="/user-type-management"
                ...
                <li
                  className={`${"/position-management" === pathName
                    ? "active"
                    : ""
                    }`}
                  // style={{
                ...
                <li
                  className={`${"/bank-management" === pathName
                    ? "active"
                    : ""
                    }`}
                  // style={{
                ...
                <li
                  className={`${"/branch-management" === pathName
                    ? "active"
                    : ""
                    }`}
                  // style={{
                ...
                <li
                  className={`${"/company-management" === pathName
                    ? "active"
                    : ""
                    }`}
                  // style={{
              ...
              >
                ...
                <li
                  className={`${"/sales-return" === pathName ||
              ...
              >
                ...
                <li
                  className={`${"/purchase-orders" === pathName ||
                ...
                <li
                  className={`${"/debit-notes" === pathName ||
